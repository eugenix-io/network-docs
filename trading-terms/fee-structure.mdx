...
* **Maker Fee**:
  A fee of 5 basis points (bps) is charged to the maker of a trade. This fee is applied when a user opens or closes a position as a maker.
* **Fee Application**:
...
* **Fee Structure**:
  ...
  * **Liquidation Fees by Asset Type**
    * **APE, GRASS:** `5%` of the position size
    * **Meme Perps:** `5%` of the position size
    * **All other Perps:** `1.5%` of the position size
* Fee Application:
