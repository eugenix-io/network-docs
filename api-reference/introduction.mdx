---
title: 'Introduction'
description: 'Welcome to Logx Network API Documentation'
---

# Introduction

Welcome to the Logx Network API documentation. This guide provides the information you need to effectively interact with the Logx Network API.

## Base Endpoint

All requests to the Logx Network API are made to the following base endpoint:

`https://logx-inf-backend-vraqb64neq-uc.a.run.app`
